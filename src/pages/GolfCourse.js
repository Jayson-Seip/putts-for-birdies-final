...
function GolfCourse() {
    ...
    return (
        <Container fluid className="  p-0 mt-2">
            ...
            <Image src="/images/18-Hole-Course.jpg" className="Golf-Course"></Image>
            <Container className="golf-course-info mt-2">
                ...
                <Button onClick={handleButtonClick}>Book a Tee-Time</Button>
            </Container>
            <Container fluid className="mt-5 mb-5">
                <Image src="\images\9-hole-course.jpg" className="Golf-Course"></Image>
                <Container className=" golf-course-info mt-2">
            ...
            <Container fluid className="mt-5 mb-5">
                <Image src="\images\Champion-coruse.jpg" className="Golf-Course"></Image>
                <Container className="golf-course-info mt-2">
